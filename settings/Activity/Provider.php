...
class Provider implements IProvider {
	...
	const APP_TOKEN_CREATED = 'app_token_created';
	const APP_TOKEN_UPDATED = 'app_token_updated';
	const APP_TOKEN_DELETED = 'app_token_deleted';
	...
	public function parse($language, IEvent $event, IEvent $previousEvent = null) {
		...
		if ($event->getSubject() === self::PASSWORD_CHANGED_BY) {
			...
			$subject = $this->l->t('You created an app token');
		} else if ($event->getSubject() === self::APP_TOKEN_UPDATED) {
			$subject = $this->l->t('You updated an app token');
