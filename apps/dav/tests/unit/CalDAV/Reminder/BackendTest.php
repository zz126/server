...
class BackendTest extends TestCase {
    ...
    public function testGetReminders() {
        ...
        $stmt->expects($this->at(0))
			...
			->will($this->returnValue([
				'id' => 0,
				'notificationdate' => (new \DateTime)->setTimestamp(698339542),
			]));
		$stmt->expects($this->at(1))
			...
			->will($this->returnValue([
				'id' => 1,
				'notificationdate' => (new \DateTime)->setTimestamp(0),
			]));

        $actual = $this->reminderBackend->getReminders();
    ...
    // public function dataGetReminder()
    // {
    //     return [
    //         [
    //             0,
    ...
    //     $queryBuilder->expects($this->at(0))
	// 		->method('select')
	// 		->with(['cr.id', 'cr.calendarid', 'objecturi', 'type', 'notificationdate', 'cr.uid', 'calendardata', 'displayname'])
    //         ->will($this->returnValue($queryBuilder));
    ...
    //     $actual = $this->reminderBackend->getReminder();
